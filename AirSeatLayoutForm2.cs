...
namespace Aircraft
{
    public partial class AirSeatLayoutForm2 : Form
    {
        string canbinname;
        int scheid;
        public AirSeatLayoutForm2(string canbin, int id)
        {
            InitializeComponent();
        ...
        private void AirSeatLayoutForm2_Load(object sender, EventArgs e)
        {
            ...
            foreach (var item in seat)
            {
                ...
                if (item.CabinTypeId == 3)
                {
                    ...
                    btn.Size = new Size((int)(FirstPanel.Width / 3), (int)(FirstPanel.Height / 5));
                ...
                else if (item.CabinTypeId == 2)
                {
                    ...
                    btn.Location = new Point((btn.Width) * (item.RowNumber - 3 - 1), height);
                }
                else if (item.CabinTypeId == 1)
                {
                    btn.Parent = Economypanel;
                    btn.Size = new Size((int)(Economypanel.Width / 15), (int)(Economypanel.Height / 7));
                    ...
                    btn.Location = new Point((btn.Width) * (item.RowNumber - 13 - 1), height);
                }
                #endregion
